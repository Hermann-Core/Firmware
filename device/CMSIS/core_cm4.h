 ...
 */
__STATIC_INLINE void __NVIC_EnableIRQ(IRQn_t IRQn)
{
  if ((int32_t)(IRQn) >= 0)
  {
    __COMPILER_BARRIER();
...
/**
  ...
  \note    IRQn must not be negative.
 */
__STATIC_INLINE uint32_t __NVIC_GetEnableIRQ(IRQn_t IRQn)
{
  if ((int32_t)(IRQn) >= 0)
  {
...
/**
  ...
  \note    IRQn must not be negative.
 */
__STATIC_INLINE void __NVIC_DisableIRQ(IRQn_t IRQn)
{
  if ((int32_t)(IRQn) >= 0)
  {
...
/**
  ...
  \note    IRQn must not be negative.
 */
__STATIC_INLINE uint32_t __NVIC_GetPendingIRQ(IRQn_t IRQn)
{
  if ((int32_t)(IRQn) >= 0)
  {
...
/**
  ...
  \note    IRQn must not be negative.
 */
__STATIC_INLINE void __NVIC_SetPendingIRQ(IRQn_t IRQn)
{
  if ((int32_t)(IRQn) >= 0)
  {
...
/**
  ...
  \note    IRQn must not be negative.
 */
__STATIC_INLINE void __NVIC_ClearPendingIRQ(IRQn_t IRQn)
{
  if ((int32_t)(IRQn) >= 0)
  {
...
/**
  ...
  \note    IRQn must not be negative.
 */
__STATIC_INLINE uint32_t __NVIC_GetActive(IRQn_t IRQn)
{
  if ((int32_t)(IRQn) >= 0)
  {
 ...
 */
__STATIC_INLINE void __NVIC_SetPriority(IRQn_t IRQn, uint32_t priority)
{
  if ((int32_t)(IRQn) >= 0)
  {
 ...
 */
__STATIC_INLINE uint32_t __NVIC_GetPriority(IRQn_t IRQn)
{
 ...
 */
__STATIC_INLINE void __NVIC_SetVector(IRQn_t IRQn, uint32_t vector)
{
 ...
 */
__STATIC_INLINE uint32_t __NVIC_GetVector(IRQn_t IRQn)
{
  uint32_t *vectors = (uint32_t *)SCB->VTOR;
